...
while attemps < 12345677901:
    ...
    if username =='MTM' and password == '63':
...
def fuck():
    ...
    print(' [+] OK Ids saved in NAHID/OK.txt')
    print(' [+] CP Ids saved in NAHID/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[NAHID]--[%s/%s]--[CP%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
